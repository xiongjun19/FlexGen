...
log_dir=/workspace/data/flex_logs_comp_v3
mkdir -p ${log_dir}
...
log_dir=/workspace/data/flex_logs_comp_kv_disk_v3
mkdir -p ${log_dir}
gpu_logs=${log_dir}/gpu_logs
cpu_logs=${log_dir}/cpu_logs
mkdir -p ${gpu_logs}
...
model_prefix="facebook"
model_name_arr=("opt-175b" "opt-175b" "opt-175b")
input_len_arr=(1024 1024 1024)
out_len_arr=(8 32 64)
bs_arr=(36 36 36)
num_bs_arr=(4 4 4) 
# percent_arr=("0 100 0 100 0 100" "0 100 0 100 0 100")
percent_arr=("0 50 0 0 0 100")
for(( i=0;i<${#model_name_arr[@]};i++)) do
   bs=${bs_arr[i]};
   num_bs=${num_bs_arr[i]};
   input_len=${input_len_arr[i]};
