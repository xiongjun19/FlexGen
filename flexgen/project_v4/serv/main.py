...
CXL_LENGTH=0
#Actual One 
history_cxl_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/flexgen/history-21july-b24/online_cxl.csv-gpu-0.csv'
online_cxl_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/flexgen/online/online_cxl.csv-gpu-0.csv'
history_disk_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/flexgen/history-21july-b24/online_disk.csv-gpu-0.csv'

disk_decode_throghput_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/flexgen/OPT-66b-DISK-OUTPUT.log'
cxl_decode_throghput_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/flexgen/OPT-66b-CXL-OUTPUT.log'
...
if MODE_SYNTHETIC=='synthetic':
    ...
    disk_decode_throghput_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/project_v4/decode_throughput/disk.log'
    cxl_decode_throghput_filepath='/home/ahussain/azr/workspace/FlexGen2/FlexGen/project_v4/decode_throughput/cxl.log'
...
def handle_data_request(data_type,value=None):
    ...
    if data_type == 'cxl_history':
        ...
        print('MAX CXL LENGTH',CXL_LENGTH)
